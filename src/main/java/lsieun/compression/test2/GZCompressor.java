package lsieun.compression.test2;
...
public class GZCompressor implements Compressor {
	...
	public static void main(String[] args) {
		...
		try {
			// Open streams
			String filepath1 = PathManager.getFilePath("input.txt");
			String filepath2 = PathManager.getFilePath("output.txt");
			String filepath3 = PathManager.getFilePath("decoded-output.txt");

			File inFile = new File(filepath2);
			FileInputStream in = new FileInputStream(inFile);
			File outFile = new File(filepath3);
