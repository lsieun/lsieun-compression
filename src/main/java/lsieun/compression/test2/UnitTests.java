...
import lsieun.compression.lossless.huffman.v2.HuffmanTable;
import lsieun.compression.lossless.huffman.v2.HuffmanTree;
...
public class UnitTests {
	...
	private void testCRC32Case(String input, int expected) {
		...
		System.out.println(expected == crc.getValue());
	}
	...
	private void testLZ77Case(String input, String expected) {
		...
		System.out.println(expected.equals(output.toString()));
	}
}
